...
export function ActivityTab() {
    ...
    //const data=[{id:1,activity:"wooo",userId:1,progress:0, totalDays:1,currentDay:1,workingDays:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"], createdAt:1, lastUpdatedAt:2}]
    return (
    <div className="w-full h-4/5 flex flex-col gap-2 items-center">
        ...
        {data.map((index:activityArr)=>{
            return <div className="w-[99%] relative h-28 border border-dotted border-gray-700 rounded-2xl grid grid-cols-12 grid-rows-12 ">
                        ...
                        <DrawerContent className="h-4/5"> 
                            <div className="w-full flex justify-between items-center text-xs font-light text-gray-600 p-2">
                                ...
                                <DrawerClose className="w-fit">
                                    <button className="w-[34px] h-[34px]  rounded-full border border-gray-700 text-sm text-black">X</button>
                                </DrawerClose>
                            </div>
                            <DrawerHeader>
                            ...
                            <div className="flex gap-2 items-center justify-center">
                                ...
                                <button className="w-44 h-12 border border-1 border-gray-700 rounded-full text-sm hover:bg-green-500 hover:border-none hover:text-white active:opacity-50 overflow-hidden">{alertBox("Mark as completed")}</button>
                            </div>
        ...
        <div className="w-full h-28 bg-red-300 text-white rounded-xl flex justify-center items-center">
