...
exports.MailSelector = MailSelector;
function MailSelector(username, activity) {
...
function template1(username, activity) {
...
function template2(username, activity) {
...
function template3(username, activity) {
...
function template4(username, activity) {
...
function template5(username, activity) {
